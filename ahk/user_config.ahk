...
Ctrl & 1::switchDesktopByNumber(1)
Ctrl & 2::switchDesktopByNumber(2)
Ctrl & 3::switchDesktopByNumber(3)
Ctrl & 4::switchDesktopByNumber(4)
Ctrl & 5::switchDesktopByNumber(5)
Ctrl & 6::switchDesktopByNumber(6)
Ctrl & 7::switchDesktopByNumber(7)
Ctrl & 8::switchDesktopByNumber(8)
Ctrl & 9::switchDesktopByNumber(9)
...
Alt & x::switchDesktopToRight()
; Return
Alt & z::switchDesktopToLeft()
...
; Alt & 1::MoveCurrentWindowToDesktop(1)
